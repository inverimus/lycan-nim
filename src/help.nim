...
proc displayHelp*(option: string = "") =
  ...
  of "a", "i", "add", "install":
    ...
    t.write(4, fgWhite, "lycan -i https://github.com/Stanzilla/AdvancedInterfaceOptions", "\n")
    t.write(4, fgWhite, "lycan -i github:Stanzilla/AdvancedInterfaceOptions", "\n")
    t.write(4, "lycan -i https://github.com/Tercioo/Plater-Nameplates/tree/master", "\n")
    t.write(4, "lycan -i github:Tercioo/Plater-Nameplates@master", "\n")
    t.write(6, fgYellow, "Including the branch will install and track the latest commit to that branch instead of releases.", "\n")
    t.write(4, fgWhite, "lycan -i https://gitlab.com/woblight/actionmirroringframe", "\n")
    t.write(4, fgWhite, "lycan -i gitlab:woblight/actionmirroringframe", "\n")
    t.write(4, "lycan -i https://www.wowinterface.com/downloads/info24608-HekiliPriorityHelper.html", "\n")
    t.write(4, "lycan -i wowint:24608", "\n")
    t.write(4, "lycan -i https://www.tukui.org/elvui", "\n")
    t.write(4, "lycan -i tukui:elvui", "\n")
  ...
  of "l", "list":
    ...
    t.write(30, false, fgWhite, "Force a reinstall of all addons. Can be used to restore from an existing lycan_addons.json file.", "\n")
